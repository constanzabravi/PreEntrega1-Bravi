...
//A ttalQuantity lo comparto por value en el return
...
export const CartProvider = ({ children }) => {
    ...
    //Funcion para filtrar productos, todos los que tengan distinto ID al que le estoy pasando me los devuelve al array Y SE ELIMINAN sin mutar el estado.  
    const removeItem = (id) => {
    ...
    //Finalmente retorno el acumulador, devolviendo cantidad total de productos
